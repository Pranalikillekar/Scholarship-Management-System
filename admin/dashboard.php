...
<head>
  ...
  <title>Smart Assistance and Support System For Scholarship using Blockchain||Dashboard</title>
  <!-- loader-->
...
?>
                  <h5 class="text-white mb-0"><?php echo htmlentities($disapp);?> <span class="float-right">Total Users</span></h5>
                    <div class="progress my-5" style="height:3px;">
                       <div class="progress-bar" style="width:100%"></div>
                    </div>
...
?>   
                  <h5 class="text-white mb-0"><?php echo htmlentities($totalrejected);?> <span class="float-right">Listed Schemes</span></h5>
                    <div class="progress my-5" style="height:3px;">
                       <div class="progress-bar" style="width:100%"></div>
                    </div>
