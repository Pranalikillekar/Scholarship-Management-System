    ...
    <section class="ftco-section contact-section ftco-degree-bg">
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
          ...
          <div class="w-100"></div>
          <div class="col-md-3">
            <p><span>Address:</span>K.L.E College Of Engineering And Technology Banantikodi Road Chikodi </p>
          </div>
          <div class="col-md-3">
            <p><span>Phone:</span> 08338274771</p>
          </div>
          <div class="col-md-3">
            <p><span>Email:</span> @klecet.edu.in</p>
          </div>
